...
func main() {
	...
	resp, err := c.MicrosoftUpdatesAPI.AppStoreMacOS.GetAllAppsV1(context.Background())
	if err != nil {
		log.Fatalf("AppStoreMacOS.GetAllAppsV1: %v", err)
	}

	fmt.Printf("macOS App Store — Microsoft apps (%d found)\n", resp.ResultCount)
	fmt.Println("===========================================")
