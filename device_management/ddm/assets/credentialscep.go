...
// CredentialScep — Asset:Credential SCEP.
...
type CredentialScep struct {
	...
	//
	// Default: Default.
	Accessible *CredentialScepAccessible `plist:"Accessible,omitempty" json:"Accessible,omitempty"`
}

// CredentialScepReference is the Reference dictionary.
// The external reference. Ensure that the asset data:
type CredentialScepReference struct {
