...
// The iTunes Search API does not return structured JSON error bodies; errors
// are indicated solely by HTTP status codes.
func (eh *ErrorHandler) HandleError(resp *resty.Response) error {
	statusCode := resp.StatusCode()

	eh.logger.Error("iTunes API request failed",
